$(function() {
	...
	function wolfAnimate() {
		...
		var arrPos = [{left: "735px",top: "165px"},
		{left: "655px",top: "210px"},
			{left: "825px",top: "192px"},
			{left: "740px",top: "242px"},
			{left: "654px",top: "272px"},
			{left: "837px",top: "262px"},
			{left: "755px",top: "324px"},
			{left: "665px",top: "344px"},
			{left: "844px",top: "340px"}
		];
